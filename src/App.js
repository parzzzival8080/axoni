        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <>
                <Navbar />
                <main>{require("./pages/morePages/MyRewards").default()}</main>
                <Footer />
                <ChatBubble />
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                <Navbar />
                <main>{require("./pages/morePages/Referral").default()}</main>
                <Footer />
                <ChatBubble />
              </>
            }
          />
          <Route
            path="/pages/morePages/Affiliate"
            element={
              <>
                <Navbar />
                <main>
                  ...
                  <React.Suspense fallback={<div>Loading...</div>}>
                    {React.createElement(
                      React.lazy(() => import("./pages/morePages/Affiliate")),
                    )}
                  </React.Suspense>
                </main>
                <Footer />
