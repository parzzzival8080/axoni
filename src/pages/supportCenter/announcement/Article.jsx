  ...
  return (
    <div className="article-container">
      ...
      <div className="article-content">
        ...
        {article.path === "/help/GLD-to-list-perpetual-futures-for-sign-crypto" && (
          <>
            ...
            <div className="article-section">
              ...
              <p>
                USDT-margined perpetual futures trading: <a href="#" className="article-link green-link">GLD Perpetual Futures Trading User Agreement</a>
              </p>
            </div>
          </>
        )}
        ...
        {article.path === "/help/GLD-to-delist-zkj-margin-trading-pair-and-perpetual-future" && (
          <div className="article-section">
            <p>
      ...
      <div className="article-footer">
        <div className="footer-links">
          <a href="#" className="footer-link green-link">Download GLD app for iOS, Android, macOS, and Windows &gt;&gt;&gt;</a>
          ...
          <a href="#" className="footer-link green-link">Join other GLD global communities &gt;&gt;&gt;</a>
        </div>
      </div>
    </div>
  );
