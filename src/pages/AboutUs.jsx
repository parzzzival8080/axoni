    ...
    <div className="bg-black text-white">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About <span className="text-[#2EBD85]">GLD</span></h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-16">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6">Our <span className="text-[#2EBD85]">Mission</span></h2>
              <p className="text-lg text-gray-300 mb-6">
                At GLD, we're on a mission to make cryptocurrency trading accessible, secure, and efficient for everyone. 
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="bg-gradient-to-br from-[#2EBD85] to-[#ff9f01] p-1 rounded-full">
                <div className="bg-black rounded-full p-8">
                  <FaChartLine className="text-[#2EBD85] w-32 h-32" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Our <span className="text-[#2EBD85]">Values</span></h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaShieldAlt className="text-[#2EBD85] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaUsers className="text-[#2EBD85] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaHandshake className="text-[#2EBD85] text-4xl" />
              </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6">Global <span className="text-[#2EBD85]">Presence</span></h2>
              <p className="text-lg text-gray-300 mb-6">
                GLD operates globally with a presence in major financial hubs across Asia, Europe, and the America. 
            ...
            <div className="flex-1 flex items-center justify-center">
              <FaGlobe className="text-[#2EBD85] w-48 h-48 opacity-80" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Join the <span className="text-[#2EBD85]">GLD</span> Community</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/spot-trading" className="bg-[#2EBD85] hover:bg-[#e56800] text-white font-bold py-3 px-8 rounded-full text-lg">
              Trade Now
            </a>
