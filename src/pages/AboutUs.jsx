    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About <span className="text-[#F0B90B]">AXONI</span></h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-16">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6">Our <span className="text-[#F0B90B]">Mission</span></h2>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="bg-gradient-to-br from-[#F0B90B] to-[#ff9f01] p-1 rounded-full">
                <div className="bg-black rounded-full p-8">
                  <FaChartLine className="text-[#F0B90B] w-32 h-32" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto max-w-6xl px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Our <span className="text-[#F0B90B]">Values</span></h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaShieldAlt className="text-[#F0B90B] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaUsers className="text-[#F0B90B] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaHandshake className="text-[#F0B90B] text-4xl" />
              </div>
      ...
      <section className="py-16 bg-black">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 flex items-center justify-center">
              <FaGlobe className="text-[#F0B90B] w-48 h-48 opacity-80" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Join the <span className="text-[#F0B90B]">AXONI</span> Community</h2>
