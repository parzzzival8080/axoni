    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About <span className="text-[#ff6901]">FLUX</span></h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-16">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6">Our <span className="text-[#ff6901]">Mission</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaShieldAlt className="text-[#ff6901] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaUsers className="text-[#ff6901] text-4xl" />
              </div>
            ...
            <div className="bg-black p-6 rounded-lg">
              <div className="flex items-center justify-center mb-4">
                <FaHandshake className="text-[#ff6901] text-4xl" />
              </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-6">Global <span className="text-[#ff6901]">Presence</span></h2>
              <p className="text-lg text-gray-300 mb-6">
            ...
            <div className="flex-1 flex items-center justify-center">
              <FaGlobe className="text-[#ff6901] w-48 h-48 opacity-80" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Join the <span className="text-[#ff6901]">FLUX</span> Community</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/signup" className="bg-[#ff6901] hover:bg-[#e56800] text-white font-bold py-3 px-8 rounded-full text-lg">
              Create Account
            </a>
            <a href="/download" className="bg-transparent border border-[#ff6901] hover:bg-[#ff6901]/10 text-white font-bold py-3 px-8 rounded-full text-lg">
              Download App
            </a>
          </div>
        </div>
