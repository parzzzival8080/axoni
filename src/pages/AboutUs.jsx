    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About <span className="text-[#2EBD85]">AXONI</span></h1>
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-16">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-300 mb-6">
                At AXONI, we're on a mission to make cryptocurrency trading accessible, secure, and efficient for everyone. 
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Join the <span className="text-[#2EBD85]">AXONI</span> Community</h2>
