...
const Affiliate = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Share your affiliate links or codes with your friends and community, or promote AXONI via social media or any other platform.",
    ...
    },
    {
      ...
      description: "Promote AXONI via social media or any other platforms, and you can earn up to 50% of your friends' trading fees.",
      hasUnderReviewBadge: true,
  ...
  <div className="container">
    <div className="hero-content">
      <div className="hero-text">
        <h1>Monetize your<br />influence with<br />AXONI</h1>
        <p className="hero-subheading">
          Are you an influencer or a content creator who shares a passion for crypto? Turn your influence into affluence and earn money by joining the AXONI Affiliate Program!
        </p>
        {/* Apply Now Button */}
