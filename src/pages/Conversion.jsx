...
const Conversion = () => {
    ...
    const fetchBtcPrice = useCallback(async () => {
      try {
        ...
        const response = await fetch(
          `https://api.kinecoin.co/api/v1/coin-balance/${uid}?apikey=${apiKey}&symbol=BTC`,
    ...
    const fetchBalance = useCallback(async () => {
      ...
      try {
        ...
        const url = `https://api.kinecoin.co/api/v1/user-wallet/${uid}/1?apikey=${apiKey}`;
    ...
    const fetchConversionHistory = async () => {
      ...
      try {
        ...
        const url = `https://api.kinecoin.co/api/v1/conversions?apikey=${apiKey}&uid=${uid}`;
    ...
    const handleConvert = async () => {
      ...
      try {
        ...
        const url = 'https://api.kinecoin.co/api/v1/conversions';
