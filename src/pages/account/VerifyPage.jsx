...
const idTypes = [
  {
    ...
    icon: <FileText size={20} className="mr-2 text-gray-700" />,
    recommended: true,
    needsBack: true,
  },
  {
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        {fileName && (
          <span className="text-xs text-green-600 mt-1 break-all">
            {fileName}
          </span>
        )}
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col items-center py-8 px-4 font-sans">
        ...
        <div className="w-full max-w-md flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl p-8 mt-12 shadow">
          ...
          <Link
            to="/"
            className="px-6 py-2 rounded-full bg-[#F88726] text-white font-semibold text-sm hover:bg-blue-600 transition shadow-lg"
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col items-center py-8 px-4 font-sans">
        ...
        <div className="w-full max-w-md flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl p-8 mt-12 shadow">
          ...
          <Link
            to="/account/profile"
            className="px-6 py-2 rounded-lg bg-[#F88726] text-white font-semibold text-sm hover:bg-blue-600 transition"
          >
            Go to Profile
          </Link>
        </div>
        ...
        return (
          <>
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <h1 className="mt-5 text-2xl font-semibold text-black dark:text-white">
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-800 p-5 rounded-xl mb-6">
              <div className="flex items-start">
                <ShieldCheck
                  size={24}
                  className="text-black dark:text-white mr-3 mt-0.5 flex-shrink-0"
                />
                <div>
      ...
      <div className="w-full max-w-md">
        {currentStep > 1 && currentStep < 6 && (
          <div className="mb-5 text-center">
            <LockKeyhole
              size={28}
              className="text-black dark:text-white mx-auto mb-2"
            />
