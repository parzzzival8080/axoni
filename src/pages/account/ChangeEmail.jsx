...
const ChangeEmail = () => {
  ...
  const handleRequestOTP = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://django.fluxcoin.tech/api/user_account/email_reset/request',
        { email: currentEmail }
      );
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await axios.post(
        'https://django.fluxcoin.tech/api/user_account/email_reset/resend_otp',
        { email: currentEmail }
      );
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://django.fluxcoin.tech/api/user_account/email_reset/verify_otp',
  ...
  const handleChangeEmail = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://django.fluxcoin.tech/api/user_account/email_reset/change',
        {
          email: currentEmail,
          otp: otp,
          new_email: newEmail
