...
const ChangePassword = () => {
  ...
  const sendOTP = async (email) => {
    ...
    try {
      const otpResponse = await axios.post(
        'https://django.kinecoin.cokinecoin.co/api/user_account/password_reset/request',
        { email: email }
      );
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const otpResponse = await axios.post(
        'https://django.kinecoin.cokinecoin.co/api/user_account/password_reset/resend-otp',
        { email: userEmail }
      );
