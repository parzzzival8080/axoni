...
const FaqSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Typically, top cryptocurrencies are ranked based on their market capitalization. On this page, you can view the market caps of all cryptocurrencies available on COINCHI. Additionally, you can sort the columns for price change and market capitalization in either ascending or descending order.'
    },
    {
      id: 'price-changes',
