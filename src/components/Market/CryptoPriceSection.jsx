...
const CryptoPriceSection = ({ cryptoData, isLoading }) => {
  ...
  const LoadingIndicator = () => (
    <div className="flex flex-col items-center justify-center py-20">
      <div className="w-10 h-10 border-4 border-gray-300 border-t-[#F0B90B] rounded-full animate-spin mb-4"></div>
                  ...
                  <tr key={crypto.id} className="hover:bg-gray-750 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex justify-center space-x-2">
                        <button className="py-1 px-3 bg-[#F0B90B] hover:bg-[#FF8C24] text-white text-sm rounded transition-colors font-medium">
                          Trade
                        </button>
        ...
        <div className="flex justify-center mt-6 space-x-1">
          ...
          <button 
            className={`w-8 h-8 flex items-center justify-center rounded text-sm transition-colors
              ${currentPage === 1 ? 'bg-[#F0B90B] text-white' : 'border border-gray-700 text-gray-400 hover:bg-gray-800'}`}
            onClick={() => goToPage(1)}
          >
            1
          </button>
          <button 
            className={`w-8 h-8 flex items-center justify-center rounded text-sm transition-colors
              ${currentPage === 2 ? 'bg-[#F0B90B] text-white' : 'border border-gray-700 text-gray-400 hover:bg-gray-800'}`}
            onClick={() => goToPage(2)}
          >
            2
          </button>
          <button 
            className={`w-8 h-8 flex items-center justify-center rounded text-sm transition-colors
              ${currentPage === 3 ? 'bg-[#F0B90B] text-white' : 'border border-gray-700 text-gray-400 hover:bg-gray-800'}`}
            onClick={() => goToPage(3)}
          >
            3
          </button>
          <button 
            className={`w-8 h-8 flex items-center justify-center rounded text-sm transition-colors
              ${currentPage === 4 ? 'bg-[#F0B90B] text-white' : 'border border-gray-700 text-gray-400 hover:bg-gray-800'}`}
            onClick={() => goToPage(4)}
          >
            4
          </button>
          ...
          <button 
            className={`w-8 h-8 flex items-center justify-center rounded text-sm transition-colors
              ${currentPage === 12 ? 'bg-[#F0B90B] text-white' : 'border border-gray-700 text-gray-400 hover:bg-gray-800'}`}
            onClick={() => goToPage(12)}
          >
            12
          </button>
