          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="text-yellow-500">Simple Earn</span>
              </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <input 
              ...
              placeholder="Search crypto"
                className="bg-gray-800 text-white border border-gray-700 rounded-lg py-3 pl-10 pr-4 w-full focus:outline-none focus:ring-1 focus:ring-yellow-500 placeholder-gray-400"
                value={search}
          ...
          {alternativeOptions.map((option, index) => (
              <div key={index} className="bg-gray-800/50 rounded-2xl p-8 text-center hover:bg-gray-800/70 transition-colors border border-gray-700">
                <div className="w-16 h-16 bg-yellow-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className={`${option.icon} text-2xl text-yellow-500`}></i>
                </div>
