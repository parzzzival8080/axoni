...
const TransferWalkthroughTrigger = () => {
  ...
  return (
    <>
      <div className="fixed top-1/2 right-6 transform -translate-y-1/2 w-80 bg-gradient-to-br from-zinc-900 to-zinc-800 border border-orange-500/30 rounded-3xl shadow-2xl backdrop-blur-xl text-white z-[1000] animate-in slide-in-from-right-4 duration-400 md:w-72 sm:right-5 sm:w-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="text-xs leading-tight text-white/70 px-3 py-2 bg-white/5 rounded-xl border-l-3 border-orange-500/50">
                <strong className="text-orange-500">⚡ Instant:</strong> Transfers between accounts are processed immediately
              </div>
              <div className="text-xs leading-tight text-white/70 px-3 py-2 bg-white/5 rounded-xl border-l-3 border-orange-500/50">
                <strong className="text-orange-500">🔄 Flexible:</strong> Move funds between Spot and Futures as needed
              </div>
              <div className="text-xs leading-tight text-white/70 px-3 py-2 bg-white/5 rounded-xl border-l-3 border-orange-500/50">
                <strong className="text-orange-500">💡 Pro Tip:</strong> Keep balanced funds for optimal trading flexibility
              </div>
              {!hasSeenWalkthrough && (
                <div className="text-xs leading-tight text-white/90 px-3 py-2 bg-orange-500/10 border border-orange-500/20 rounded-xl border-l-3 border-orange-500">
                  <strong className="text-orange-500">👋 Welcome!</strong> Take the transfer tour to master account management
                </div>
              )}
            </div>
          </div>
