...
const TransferWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to Kine Transfer',
    ...
    },
    {
      ...
      description: 'You\'re in the Funding section where you can manage transfers between your different trading accounts. Access other account features from here.',
    ...
    },
    {
      ...
      description: 'Choose which cryptocurrency you want to transfer. Use the search function to quickly find your desired asset from hundreds of available options.',
    ...
    },
    {
      ...
      description: 'Select which account to transfer from (Spot or Futures) and which account to transfer to. Use the swap button to quickly reverse the direction.',
    ...
    },
    {
      ...
      description: 'Specify how much you want to transfer. Click "Max" to transfer your entire available balance, or enter a custom amount.',
    ...
    },
    {
      ...
      description: 'Monitor your current Spot and Futures balances for the selected asset. This helps you make informed transfer decisions.',
    ...
    },
    {
      ...
      description: 'Click this button to execute your transfer. Ensure all details are correct before proceeding as transfers are processed immediately.',
    ...
    },
    {
      ...
      description: 'View all your past transfers between accounts. Track assets, amounts, directions, and transaction status for complete transparency.',
    ...
    },
    {
      ...
      description: 'You\'re now equipped to efficiently manage transfers between your Spot and Futures accounts. Start optimizing your trading strategy!',
      target: null,
      position: 'center',
      type: 'completion',
      duration: 0
            ...
            <div className="text-center py-4">
              ...
              <div className="text-left bg-orange-500/10 border border-orange-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">💡 Pro Tip:</strong> Always check balances before making large transfers
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">🔄 Strategy:</strong> Keep funds balanced between Spot and Futures for flexibility
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">📊 Track:</strong> Monitor transfer history for better account management
                </div>
              </div>
            </div>
          )}
