            ...
            <div className="text-center py-4">
              ...
              <div className="text-left bg-blue-500/10 border border-blue-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">💡 Pro Tip:</strong> Always check balances before making large transfers
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">🔄 Strategy:</strong> Keep funds balanced between Spot and Futures for flexibility
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">📊 Track:</strong> Monitor transfer history for better account management
                </div>
              </div>
            </div>
          )}
