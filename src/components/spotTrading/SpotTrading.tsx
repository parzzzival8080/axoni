...
const TradeForm = ({
  ...
  const [notification, setNotification] = useState(
    () => null as { message: string; type?: "success" | "error" } | null
  );
      ...
      <div className="form-group">
        ...
        <div className="slider-container">
          <input
            ...
            value={
              maxTradeAmount > 0
                ? (parseFloat(amount) / maxTradeAmount) * 100
                : 0
            }
...
const FavoriteItem = memo(
  ({ coin, isActive }: { coin: FavoriteCoin; isActive: boolean }) => {
    ...
    return (
      <div
        className={`favorite-item-atomic${isActive ? " active" : ""}`.trim()}
      >
        <img src={coin.logo_path} alt={coin.symbol} className="fav-coin-logo" />
        <span className="fav-pair">
          {coin.symbol}/{coin.pair_name}{" "}
          <span className="fav-leverage">10x</span>
        </span>
        <span className={`fav-change ${changeClass}`}>
          {changeSign}
    ...
    <div className="spot-trading-container okx-dark">
      ...
      <header className="okx-header">
        <div className="header-left">
          <div className="logo">
            <img src="/okx-logo.svg" alt="OKX Logo" />
          </div>
          <nav>
      ...
      <div className="sub-header">
        <div className="coin-info">
          <div className="coin-icon">
            <img
              src={`/coins/${cryptoData.cryptoSymbol.toLowerCase()}.svg`}
              alt={cryptoData.cryptoSymbol}
            />
          </div>
          <div className="coin-pair">
            {cryptoData.cryptoSymbol}/{cryptoData.usdtSymbol}
          </div>
        ...
        <div className="price-stats">
          <div className="stat">
            <div className="value green">
              {formatNumber(cryptoData.cryptoPrice, 2)}
            </div>
