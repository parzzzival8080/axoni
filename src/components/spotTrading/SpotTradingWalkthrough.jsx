...
const SpotTradingWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to AXONI Spot Trading',
  ...
  return (
    <>
      ...
      <div 
        ref={overlayRef}
        className={`fixed z-[10001] bg-gradient-to-br from-zinc-900 to-zinc-800 border border-yellow-500/40 rounded-xl shadow-2xl backdrop-blur-xl text-white animate-in slide-in-from-bottom-4 zoom-in-95 duration-300 ${
        ...
        <div className="p-4">
          ...
          {currentStepData.type === 'completion' && (
            <div className="text-center py-4">
              ...
              <div className="text-left bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-yellow-500">Pro Tip:</strong> Start with small amounts to get familiar with the platform
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-yellow-500">Remember:</strong> Always do your own research before making trading decisions
                </div>
              </div>
            </div>
          )}
        ...
        <div className="px-4 py-3 border-t border-white/10">
          {currentStepData.type === 'welcome' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={handleStart}
                className="px-5 py-2.5 bg-gradient-to-r from-yellow-500 to-yellow-400 text-white rounded-lg text-xs font-semibold hover:shadow-lg hover:shadow-yellow-500/25 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
              >
          ...
          {currentStepData.type === 'completion' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={onClose}
                className="px-5 py-2.5 bg-gradient-to-r from-yellow-500 to-yellow-400 text-white rounded-lg text-xs font-semibold hover:shadow-lg hover:shadow-yellow-500/25 hover:-translate-y-0.5 transition-all duration-200"
              >
                Start Trading
              </button>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
                ...
                <button 
                  ...
                  className="p-1.5 bg-yellow-500/10 text-yellow-500 border border-yellow-500/30 rounded hover:bg-yellow-500/20 hover:border-yellow-500/40 transition-all duration-200"
