...
const SpotTradingWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to GLD Spot Trading',
  ...
  return (
    <>
      ...
      <div 
        ref={overlayRef}
        className={`fixed z-[10001] bg-gradient-to-br from-zinc-900 to-zinc-800 border border-[#2EBD85]/40 rounded-xl shadow-2xl backdrop-blur-xl text-white animate-in slide-in-from-bottom-4 zoom-in-95 duration-300 ${
        ...
        <div className="p-4">
          ...
          {currentStepData.type === 'completion' && (
            <div className="text-center py-4">
              ...
              <div className="text-left bg-[#2EBD85]/50/10 border border-[#2EBD85]/20 rounded-lg p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">Pro Tip:</strong> Start with small amounts to get familiar with the platform
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">Remember:</strong> Always do your own research before making trading decisions
                </div>
              </div>
            </div>
          )}
        ...
        <div className="px-4 py-3 border-t border-white/10">
          {currentStepData.type === 'welcome' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={handleStart}
                className="px-5 py-2.5 bg-gradient-to-r from-[#2EBD85] to-[#259A6C] text-white rounded-lg text-xs font-semibold hover:shadow-lg hover:shadow-[#2EBD85]/25 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
              >
          ...
          {currentStepData.type === 'completion' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={onClose}
                className="px-5 py-2.5 bg-gradient-to-r from-[#2EBD85] to-[#259A6C] text-white rounded-lg text-xs font-semibold hover:shadow-lg hover:shadow-[#2EBD85]/25 hover:-translate-y-0.5 transition-all duration-200"
              >
                Start Trading
              </button>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
                ...
                <button 
                  ...
                  className="p-1.5 bg-[#2EBD85]/50/10 text-[#2EBD85] border border-[#2EBD85]/30 rounded hover:bg-[#2EBD85]/50/20 hover:border-[#2EBD85]/40 transition-all duration-200"
