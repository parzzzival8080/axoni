...
const News = () => {
  const newsArticles = [
    ...
    {
      title: 'COINCHI Launches New Trading Tools',
      description: 'COINCHI introduces advanced analytics and automation features to help traders maximize performance and efficiency.',
      date: '25 May 2025',
      category: 'Platform',
      image: news3
    }
  ...
  return (
    <div className="bg-black py-16">
      <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-24">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-8 text-white">COINCHI News</h2>
