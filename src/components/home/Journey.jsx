  ...
  <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 hover:bg-gray-900/70 transition-colors flex flex-col h-full">
    ...
    <div className="mt-auto pt-2">
      <Link
        ...
        className="w-full block text-center bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-bold px-4 py-2 rounded-md transition-colors shadow-md uppercase tracking-wide"
      >
        {buttonText}
      </Link>
    </div>
