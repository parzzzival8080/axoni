            ...
            <div className="text-center py-4">
              ...
              <div className="text-left bg-orange-500/10 border border-orange-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">💡 Pro Tip:</strong> Always verify conversion amounts before confirming
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">🔄 Remember:</strong> Check exchange rates for the best conversion timing
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">📊 Track:</strong> Monitor your conversion history for better planning
                </div>
              </div>
            </div>
          )}
