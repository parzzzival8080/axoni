...
const ConversionWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: "welcome",
      title: "Welcome to GLD Conversion",
      description:
    ...
    },
    {
      ...
      description:
        "GLD offers zero trading fees, no slippage, and supports many trading pairs. These features make conversions cost-effective and reliable.",
    ...
    },
    {
      ...
      description:
        "You're now equipped to convert cryptocurrencies efficiently on GLD. Start with small amounts to familiarize yourself with the process.",
      target: null,
      position: "center",
      type: "completion",
      duration: 0,
          ...
          {currentStepData.type === "completion" && (
            <div className="text-center py-4">
              ...
              <div className="text-left bg-[#2EBD85]/50/10 border border-[#2EBD85]/20 rounded-2xl p-3 space-y-1.5">
                ...
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">🔄 Remember:</strong> Check
