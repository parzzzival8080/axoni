...
const TradingChart = ({ selectedSymbol = "BTC" }) => {
  ...
  const getChartConfig = (currentSymbol) => {
    ...
    return {
      ...
      interval: timeframe,
      datafeedUrl: "https://api.COINCHIcoin.tech/api/v1",
      ...
      tvWidget.onChartReady(() => {
        ...
        tvWidget.headerReady().then(() => {
          ...
          button.addEventListener("click", () => {
            ...
            fetch("https://api.COINCHIcoin.tech/api/v1/status")
  ...
  return (
    <div className="trading-chart-dynamic trading-chart-container md:relative md:z-auto z-0 overflow-hidden">
