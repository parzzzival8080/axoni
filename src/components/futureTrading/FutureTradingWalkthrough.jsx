            ...
            <div className="text-center py-4">
              ...
              <div className="text-left bg-blue-500/10 border border-blue-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">⚠️ Risk Warning:</strong> Futures trading involves high risk due to leverage
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">💡 Pro Tip:</strong> Always use stop-losses and proper position sizing
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-blue-500">📚 Remember:</strong> Practice with small amounts before scaling up
                </div>
              </div>
            </div>
          )}
