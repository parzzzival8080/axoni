...
const FutureTradingWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to GLD Futures Trading',
            ...
            <div className="text-center py-4">
              ...
              <div className="flex justify-center gap-8 mb-3">
                <div className="text-center">
                  <span className="block text-lg font-bold text-[#2EBD85] mb-0.5">8</span>
                  <span className="text-xs text-white/60 uppercase tracking-wide">Key Features</span>
                </div>
                <div className="text-center">
                  <span className="block text-lg font-bold text-[#2EBD85] mb-0.5">~2min</span>
          ...
          {currentStepData.type === 'completion' && (
            <div className="text-center py-4">
              <div className="w-20 h-20 mx-auto mb-6 relative">
                <div className="w-full h-full bg-[#2EBD85]/50 rounded-full flex items-center justify-center animate-in zoom-in duration-500">
              ...
              <div className="text-left bg-[#2EBD85]/50/10 border border-[#2EBD85]/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">⚠️ Risk Warning:</strong> Futures trading involves high risk due to leverage
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">💡 Pro Tip:</strong> Always use stop-losses and proper position sizing
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-[#2EBD85]">📚 Remember:</strong> Practice with small amounts before scaling up
                </div>
              </div>
            </div>
          )}
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
                ...
                <button 
                  ...
                  className="p-1.5 bg-[#2EBD85]/50/10 text-[#2EBD85] border border-[#2EBD85]/30 rounded-xl hover:bg-[#2EBD85]/50/20 hover:border-[#2EBD85]/40 transition-all duration-200"
