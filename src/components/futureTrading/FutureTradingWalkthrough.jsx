...
const FutureTradingWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to COINCHI Futures Trading',
    ...
    {
      id: 'subheader',
      title: 'Futures Market Data & Selection',
      description: 'View real-time futures pricing, leverage information, and switch between different crypto futures contracts. Track funding rates and open interest here.',
      target: '.sub-header',
      position: 'bottom',
      type: 'highlight',
      duration: 5000
    ...
    {
      id: 'favorites',
      title: 'Quick Futures Access',
      description: 'Your favorite futures contracts are displayed here for instant access. Add frequently traded pairs to your favorites for faster navigation.',
      target: '.favorites-bar-atomic',
      position: 'bottom',
      type: 'highlight',
      duration: 4000
    },
    {
      id: 'chart',
      title: 'Advanced Futures Chart',
      description: 'Professional TradingView chart optimized for futures trading. Includes advanced indicators, funding rate overlays, and liquidation level markers for risk management.',
      target: '.trading-chart-dynamic',
      position: 'right',
      type: 'highlight',
      duration: 6000
    },
    {
      id: 'orderbook',
      title: 'Live Futures Order Book',
      description: 'Real-time market depth for futures contracts. Monitor bid/ask spreads, liquidity levels, and identify potential support/resistance zones for better entries.',
      target: '.order-book',
      position: 'left',
      type: 'highlight',
      duration: 5000
    ...
    {
      id: 'tradeform',
      title: 'Futures Trading Interface',
      description: 'Execute long and short positions with leverage. Set stop-loss, take-profit orders, and manage position sizing. Choose between market, limit, and advanced order types.',
      target: '.trade-form-container',
      position: 'left',
      type: 'highlight',
      duration: 6000
    },
    {
      ...
      description: 'Monitor your open positions, pending orders, and trading history. Track PnL, margin usage, and manage risk across all your futures positions.',
    ...
    {
      id: 'coin-selection',
      title: 'Contract Selection Dropdown',
      description: 'Click on any futures contract pair to open the selection dropdown. Search and switch between different cryptocurrency futures with various leverage options.',
    ...
    {
      id: 'complete',
      title: 'Ready for Futures Trading!',
      description: 'You\'re now equipped with all the tools for professional futures trading. Remember: use leverage responsibly, always set stop-losses, and never risk more than you can afford to lose.',
      target: null,
      position: 'center',
      type: 'completion',
      duration: 0
  ...
  return (
    <>
      ...
      <div 
        ref={overlayRef}
        className={`fixed z-[10001] bg-gradient-to-br from-zinc-900 to-zinc-800 border border-orange-500/40 rounded-3xl shadow-2xl backdrop-blur-xl text-white animate-in slide-in-from-bottom-4 zoom-in-95 duration-300 ${
        ...
        <div className="p-4">
          ...
          {currentStepData.type === 'completion' && (
            <div className="text-center py-4">
              ...
              <div className="text-left bg-orange-500/10 border border-orange-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">⚠️ Risk Warning:</strong> Futures trading involves high risk due to leverage
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">💡 Pro Tip:</strong> Always use stop-losses and proper position sizing
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-orange-500">📚 Remember:</strong> Practice with small amounts before scaling up
                </div>
              </div>
            </div>
          )}
        ...
        <div className="px-4 py-3 border-t border-white/10">
          {currentStepData.type === 'welcome' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={handleStart}
                className="px-5 py-2.5 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-xl text-xs font-semibold hover:shadow-lg hover:shadow-orange-500/25 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
              >
          ...
          {currentStepData.type === 'completion' && (
            <div className="flex gap-3 justify-center">
              ...
              <button 
                onClick={onClose}
                className="px-5 py-2.5 bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-xl text-xs font-semibold hover:shadow-lg hover:shadow-orange-500/25 hover:-translate-y-0.5 transition-all duration-200"
              >
                Start Trading
              </button>
            </div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex gap-2 items-center">
                ...
                <button 
                  ...
                  className="p-1.5 bg-orange-500/10 text-orange-500 border border-orange-500/30 rounded-xl hover:bg-orange-500/20 hover:border-orange-500/40 transition-all duration-200"
...
export default FutureTradingWalkthrough; 