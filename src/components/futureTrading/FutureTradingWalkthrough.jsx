...
const FutureTradingWalkthrough = ({ onClose, isOpen }) => {
  ...
  const walkthroughSteps = [
    {
      id: 'welcome',
      title: 'Welcome to AXONI Futures Trading',
            ...
            <div className="text-center py-4">
              ...
              <div className="flex justify-center gap-8 mb-3">
                <div className="text-center">
                  <span className="block text-lg font-bold text-yellow-500 mb-0.5">8</span>
                  <span className="text-xs text-white/60 uppercase tracking-wide">Key Features</span>
                </div>
                <div className="text-center">
                  <span className="block text-lg font-bold text-yellow-500 mb-0.5">~2min</span>
            ...
            <div className="text-center py-4">
              ...
              <div className="text-left bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-3 space-y-1.5">
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-yellow-500">⚠️ Risk Warning:</strong> Futures trading involves high risk due to leverage
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-yellow-500">💡 Pro Tip:</strong> Always use stop-losses and proper position sizing
                </div>
                <div className="text-xs text-white/90 leading-tight">
                  <strong className="text-yellow-500">📚 Remember:</strong> Practice with small amounts before scaling up
                </div>
              </div>
            </div>
          )}
