...
function TradeForm({ symbol = 'BTC' }) {
  ...
  const fetchWalletBalance = async () => {
    ...
    try {
      ...
      // For coin pair ID 1 (BTC/USDT), extract balances correctly
      const cryptoBalance = balanceData.btc || 0;
      const usdtBalance = balanceData.usdt || balanceData.available_balance || 0;
  ...
  const calculateMaxAmount = () => {
    ...
    const usdtBalanceValue = parseFloat(walletBalance.usdtBalance);
    const leverageValue = parseFloat(leverage);
    
    // Max amount = (USDT balance * leverage) / price
    const maxAmount = (usdtBalanceValue * leverageValue) / numericPrice;
    return maxAmount;
  };
        ...
        <div className="slider-labels">
          ...
          <div className="balance-info">
            <div className="available-balance">
              Available {walletBalance.usdtBalance} USDT
