            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="text-xs leading-tight text-white/70 px-3 py-2 bg-white/5 rounded-xl border-l-3 border-yellow-500/50">
                  <strong className="text-yellow-500">⚠️ Warning:</strong> Futures trading involves high risk due to leverage
                </div>
                <div className="text-xs leading-tight text-white/70 px-3 py-2 bg-white/5 rounded-xl border-l-3 border-yellow-500/50">
                  <strong className="text-yellow-500">💡 Pro Tip:</strong> Always use stop-losses in leveraged positions
                </div>
                {!hasSeenWalkthrough && (
                  <div className="text-xs leading-tight text-white/90 px-3 py-2 bg-yellow-500/10 border border-yellow-500/20 rounded-xl border-l-3 border-yellow-500">
                    <strong className="text-yellow-500">👋 Welcome!</strong> We strongly recommend taking the futures tour first
                  </div>
                )}
              </div>
            </div>
