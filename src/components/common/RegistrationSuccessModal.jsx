        ...
        <div className="relative z-10 pt-12 pb-6">
          ...
          <div className="flex justify-center mb-4">
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-full animate-pulse opacity-20" style={{ backgroundColor: '#014EB2' }}></div>
              <div className="relative w-16 h-16 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: '#014EB2' }}>
                ...
                <div 
                  ...
                  style={{ animationDelay: '1s', color: '#014EB2' }}
                >
          ...
          <div className="text-center px-6 mb-4">
            ...
            <div className="w-12 h-1 rounded-full mx-auto mb-3" style={{ backgroundColor: '#014EB2' }}></div>
            <p className="text-gray-600 text-base leading-relaxed">
              Your account has been successfully created.<br />
              <span className="font-medium" style={{ color: '#014EB2' }}>Get ready to start trading!</span>
            </p>
          </div>
          ...
          <div className="px-6 mb-4">
            <button
              ...
              style={{ backgroundColor: '#014EB2' }}
            >
              {/* Button Background Effect */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ backgroundColor: '#014EB2' }}></div>
          ...
          <div className="text-center px-6">
            <p className="text-xs text-gray-400">
              Need help? Visit our{' '}
              <span className="hover:underline cursor-pointer font-medium" style={{ color: '#014EB2' }}>
                support center
              </span>
            </p>
          </div>
