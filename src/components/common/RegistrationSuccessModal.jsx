        ...
        <div className="relative z-10 pt-12 pb-6">
          ...
          <div className="flex justify-center mb-4">
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-full animate-pulse opacity-20" style={{ backgroundColor: '#2EBD85' }}></div>
              <div className="relative w-16 h-16 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: '#2EBD85' }}>
                ...
                <div 
                  ...
                  style={{ animationDelay: '1s', color: '#2EBD85' }}
                >
          ...
          <div className="px-6 mb-4">
            <button
              ...
              style={{ backgroundColor: '#2EBD85' }}
            >
              {/* Button Background Effect */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ backgroundColor: '#2EBD85' }}></div>
