      ...
      <div className="w-full max-w-lg text-center">
        ...
        <div className="flex justify-center px-4">
          <button 
            ...
            className="w-full max-w-[365px] h-[45px] sm:h-[50px] bg-[#ff6901] hover:bg-[#e55a01] text-white font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#ff6901] focus:ring-opacity-50 text-sm sm:text-base lg:text-lg flex items-center justify-center">
            START
          </button>
        </div>
      </div>
