...
const articleData = {
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: 'Log in to your account at <strong>coinchi.co</strong>, go to the <strong class="text-gray-900">Assets</strong>, and select <strong class="text-blue-600">Withdrawal</strong>.'
          },
          {
            number: 2,
  ...
  'withdrawal-deposit-fees': {
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: '<strong class="text-green-600">Deposits are generally free</strong> on most platforms, including COINCHI. You only pay the network fee from your sending wallet.'
          },
          {
            number: 2,
    ...
    notes: [
      ...
      'Internal transfers (between COINCHI accounts) may have different fee structures.',
