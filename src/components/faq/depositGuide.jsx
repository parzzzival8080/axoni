...
const articleData = {
  'how-to-make-deposit': {
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: 'Log in to your account at <strong class="text-blue-600">COINCHIcoin.tech</strong>, navigate to the <strong class="text-gray-900">Assets</strong> section, and click on <strong class="text-blue-600">Deposit</strong>.'
          },
          {
            number: 2,
            content: 'Choose the cryptocurrency you want to deposit from the <strong class="text-gray-900">Select crypto</strong> dropdown and select your preferred network in the <strong class="text-gray-900">Deposit network</strong> field, then click <strong class="text-blue-600">Next</strong>.'
          }
        ],
        images: [
          {
        ...
        additionalSteps: [
          ...
          {
            number: 4,
            content: 'Complete your deposit by either <strong class="text-blue-600">copying</strong> the deposit address to your sending platform, or <strong class="text-blue-600">scanning the QR code</strong> with your mobile wallet app.'
          }
        ],
        additionalImages: [
          {
    ...
    notes: [
      ...
      'You can find the minimum deposit for connection numbers, and contract address in the <strong class="text-blue-600">Deposit</strong> page.',
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: 'Check if you\'ve sent the deposit to the correct <strong class="text-blue-600">network</strong> and <strong class="text-blue-600">address</strong>. Sending to the wrong network is the most common cause of lost deposits.'
          },
          {
            number: 2,
            content: 'Verify that the deposit amount meets the <strong class="text-blue-600">minimum deposit requirement</strong>. Deposits below the minimum threshold will not be credited to your account.'
          },
          {
            number: 3,
            content: 'Check the <strong class="text-blue-600">network confirmation status</strong> - some networks require multiple confirmations before the deposit is credited.'
          },
          {
            number: 4,
            content: 'Verify that you included the correct <strong class="text-blue-600">tag/memo</strong> if required for your chosen cryptocurrency (XRP, XLM, EOS, etc.).'
          }
        ],
        images: [
          {
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: 'Navigate to <strong class="text-blue-600">Assets</strong> > <strong class="text-blue-600">Deposit</strong> in your account dashboard.'
          },
          {
            number: 2,
    ...
    sections: [
      {
        ...
        steps: [
          {
            number: 1,
            content: 'Go to <strong class="text-blue-600">Assets</strong> > <strong class="text-blue-600">Transaction History</strong> in your account.'
          },
          {
            number: 2,
            content: 'Filter by <strong class="text-blue-600">Deposit</strong> to see all your deposit transactions.'
          },
          {
            number: 3,
      ...
      },
      {
        ...
        steps: [
          ...
          {
            number: 2,
            content: '<strong class="text-blue-600">Confirming:</strong> Your deposit has been detected and is awaiting network confirmations.'
          },
          {
            number: 3,
